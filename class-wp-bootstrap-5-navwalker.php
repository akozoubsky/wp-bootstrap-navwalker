 ...
 *
 * @wordpress-plugin
 * Plugin Name: WP Bootstrap 5 Navwalker
...
if ( ! class_exists( 'WP_Bootstrap_5_Navwalker' ) ) :
	/**
	 * WP_Bootstrap_5_Navwalker class.
	 */
	class WP_Bootstrap_5_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			*/
			...
			if ( $this->has_children && 0 === $depth ) {
				$atts['href']          = '#';
				$atts['aria-expanded'] = 'false';
				$atts['class']         = 'nav-link dropdown-toggle';  // Class change
				$atts['id']            = 'menu-item-dropdown-' . $item->ID;
				$atts['role']          = 'button';  // New attribute for accessibility
				$atts['data-bs-toggle']= 'dropdown';  // New attribute for Bootstrap 5
			} else {
		...
		public static function fallback( $args ) {
			...
			// Code has been updated for Bootstrap 5
			$fallback_output .= '<li class="nav-link"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '">' . esc_html__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '</a></li>';
			$fallback_output .= '</ul>';
